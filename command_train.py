...
if parameters['reconstructed_path'] != 'None':
   result_vtu_to_vtu(parameters['data_dir'], parameters['reconstructed_path'], parameters['vtu_fields'], autoencoder, full_set.tk, full_set.tb, reconstruct_start_index, reconstruct_end_index, model_device = device, dimension = dimension)
